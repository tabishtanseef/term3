...
{
	var _url = Number(String(String(found[i].url).replace("#page",'')));
	out+='<div class="tipue_search_content_title"><a href="#page'+(_url)+'"'+tipue_search_w+'>Page'+(_url)+'</a></div>';if(set.debug)
{out+='<div class="tipue_search_content_debug">Score: '+found[i].score+'</div>';}
if(set.showURL)
{var s_u=found[i].url.toLowerCase();if(s_u.indexOf('http://')==0)
{s_u=s_u.slice(7);}

var __url = Number(String(String(found[i].url).replace("#page",'')));
//console.log(_url)
out+='<div class="tipue_search_content_url"><a href="#page'+(__url)+'"'+tipue_search_w+'>#page'+(__url)+'</a></div>';}
if(found[i].desc)
